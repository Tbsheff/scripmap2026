...
declare namespace google.maps {
	...
	export interface CoordinateTransformer {
		 ...
		 */
		fromLatLngAltitude(
			latLngAltitude: google.maps.LatLngAltitude | google.maps.LatLngAltitudeLiteral,
	...
	export class event {
		 ...
		 */
		static trigger(this: any, instance: object, eventName: string, ...eventArgs: any[]): void;
	}
	/**
	 * Loads a <a
...
declare namespace google.maps.Data {
	...
	export class Feature {
		 ...
		 */
		setGeometry(newGeometry: google.maps.Data.Geometry | null | google.maps.LatLng | google.maps.LatLngLiteral): void;
		/**
	...
	export class MultiPolygon implements google.maps.Data.Geometry {
		...
		constructor(
			elements: (
				...
				| (google.maps.Data.LinearRing | (google.maps.LatLng | google.maps.LatLngLiteral)[])[]
			)[],
		);
		forEachLatLng(callback: (a: google.maps.LatLng) => void): void;
		/**
...
declare namespace google.maps.journeySharing {
	...
	export interface FleetEngineDeliveryVehicleLocationProviderOptions {
		...
		activePolylineCustomization?:
			| ((a: google.maps.journeySharing.DeliveryVehiclePolylineCustomizationFunctionParams) => void)
	...
	export interface FleetEngineShipmentLocationProviderOptions {
		 ...
		 */
		activePolylineCustomization?:
			| ((a: google.maps.journeySharing.ShipmentPolylineCustomizationFunctionParams) => void)
			| google.maps.PolylineOptions
			| null;
		/**
		 * Provides JSON Web Tokens for authenticating the client to Fleet Engine.
	...
	export interface FleetEngineTripLocationProviderOptions {
		 ...
		 */
		activePolylineCustomization?:
			| ((a: google.maps.journeySharing.TripPolylineCustomizationFunctionParams) => void)
			| google.maps.PolylineOptions
			| null;
		/**
		 * Provides JSON Web Tokens for authenticating the client to Fleet Engine.
	...
	export interface FleetEngineVehicleLocationProviderOptions {
		 ...
		 */
		activePolylineCustomization?:
			| ((a: google.maps.journeySharing.VehiclePolylineCustomizationFunctionParams) => void)
			| google.maps.PolylineOptions
			| null;
		/**
		 * Provides JSON Web Tokens for authenticating the client to Fleet Engine.
	...
	export interface JourneySharingMapViewOptions {
		...
		anticipatedRoutePolylineSetup?:
			| google.maps.journeySharing.PolylineSetupOptions
			| ((a: google.maps.journeySharing.DefaultPolylineSetupOptions) => google.maps.journeySharing.PolylineSetupOptions)
			| null;
		/**
...
declare namespace google.maps.localContext {
	...
	export class LocalContextMapView implements google.maps.localContext.LocalContextMapViewOptions {
		...
		pinOptionsSetup?:
			| ((a: { isHighlighted: boolean; isSelected: boolean }) => google.maps.localContext.PinOptions | null | undefined)
